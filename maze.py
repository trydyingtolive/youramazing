...
class Maze(base.MazeBase):
    ...
    def _recursive_backtracking(self):
        ...
        x = (2 * self.col_count + 1)
        y = (2 * self.row_count + 1)

        for ix in range(1, 14):
            for iy in range(1, 6):
                self.maze[iy][ix] = [255,255,255]
        self.maze[6,13]=[255,255,255]
        
        for ix in range(x - 18, x-1):
            for iy in range(y-6, y-1):
                self.maze[iy][ix] = [255,255,255]
        self.maze[y-2, x-19] = [255,255,255]
